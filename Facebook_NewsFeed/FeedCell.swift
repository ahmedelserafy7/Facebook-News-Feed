...
class FeedCell: UICollectionViewCell {
    ...
    didSet {
     ...
     //   postImageView.image = nil
        ...
        /* if let statusImage = post?.statusImage {
            postImageView.image = UIImage(named: statusImage)
        }*/
    ...
    /*
     ...
     didSet {
     likeButton.backgroundColor = isHighlighted ? UIColor.rbg(red: 51/255, green: 90/255, blue: 149/255) : UIColor.rbg(red: 143, green: 158, blue: 163)
     ...
     didSet {
     likeButton.backgroundColor = isSelected ? UIColor.rbg(red: 51/255, green: 90/255, blue: 149/255): UIColor.rbg(red: 143, green: 158, blue: 163)
     }
     }
     */
    ...
    func setupViews() {
       ...
       postImageView.addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(FeedCell.animation)))
        ...
        //statusPost.backgroundColor = .green
        // addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "H:|-8-[v0(44)]-8-[v1]|", options: NSLayoutFormatOptions(), metrics: nil, views: ["v0": profileImageView,"v1":labelName]))
        ...
        //addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:|-16-[v0(44)]", options: NSLayoutFormatOptions(), metrics: nil, views: ["v0": profileImageView]))
...
//        commentView.addConstraintsWithFormat(format: "|", views: commentdividedLine)
        
        commentView.addConstraintsWithFormat(format: "V:|-6-[v0(0.4)]-8-[v1(20)]", views: commentdividedLine, profileCommentView)
//        commentView.addConstraintsWithFormat(format: "V:|-14-[v0(20)]", views: profileCommentView)
