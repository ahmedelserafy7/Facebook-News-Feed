//
//  FirendsRequests.swift
//  Facebook_NewsFeed
//
//  Created by Ahmed.S.Elserafy on 8/11/17.
...
class FriendRequestsController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        tableView.separatorColor = UIColor.rbg(red: 229, green: 231, blue: 235)
...
class RequestHeader: UITableViewHeaderFooterView {
    ...
    let bottomBorderView: UIView = {
        let view = UIView()
        view.backgroundColor = UIColor.rbg(red: 229, green: 231, blue: 235)
        return view
    }()
